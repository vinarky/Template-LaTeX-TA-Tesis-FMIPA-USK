...
\author{Nama Lengkap}    % Nama lengkap penulis sesuai identitas resmi
...
\input{BAB I}           % File: BAB I.tex (Berisi Pendahuluan)
\input{BAB II}          % File: BAB II.tex (Berisi Tinjauan Pustaka)
\input{BAB III}         % File: BAB III.tex (Berisi Metode Penelitian)

% Bab IV dan V biasanya dinonaktifkan (%) saat tahap Proposal
%\input{BAB IV}          % File: BAB IV.tex (Hasil dan Pembahasan)
%\input{BAB V}           % File: BAB V.tex (Kesimpulan dan Saran)

% --- Bagian Akhir (Back Matter) ---
\daftarKepustakaan{references} % Memanggil referensi dari file references.bib
\input{Lampiran}               % Memasukkan file Lampiran.tex (jika ada)
